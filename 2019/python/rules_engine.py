...
"""
	...
	def v677_1(self):
		...
		1) Interest Rate must be a number greater than or equal to 0 or NA, and cannot be left blank.

		Impact of S2155: Update to: 
		1) Interest Rate must be a number greater than or equal to 0, Exempt or NA, and cannot be left blank."""
		field = "Interest Rate"
		edit_name = "v677_1"
