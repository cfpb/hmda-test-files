...
class rules_engine(object):
	...
	def __init__(self, config_data, state_codes, geographic_data, full_lar_file_check=False,
		lar_schema_file="../schemas/lar_schema.json", ts_schema_file="../schemas/ts_schema.json"):
		#, geo_config_file="configurations/geographic_data.yaml", config_file='configurations/clean_file_config.yaml'):
	...
	def create_edit_report(self):
		...
		for rule in dir(self):
			if rule[:1] in ("s", "v") and rule[1:4].isdigit()==True:
				getattr(self, rule)()
...
"""
	...
	def v699(self):
		...
		Automated Underwriting System: 5 equals 5, then
		the corresponding Automated Underwriting System
		Result: 1; Automated Underwriting System Result: 2;
	...
	def q654(self):
		"""
		1) If Income is greater than $5,000 (reported as 5) and
		Action Taken equals 1, 2, or 8, the DTI should
