...
"""
	...
	def v663(self):
		...
		field = "App Credit Score"
		edit_name = "v663"
		fail_df = self.lar_df[(self.lar_df.action_taken.isin(("4", "5", "6")))&((self.lar_df.app_credit_score!="8888")|
			(~self.lar_df.app_score_name.isin(["9", "Exempt"]))|(self.lar_df.app_score_code_8!=""))]
		self.results_wrapper(edit_name=edit_name, field_name=field, fail_df=fail_df)
