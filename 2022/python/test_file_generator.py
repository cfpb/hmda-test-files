...
class test_data_creator(object):
	...
	def __init__(self, state_codes, county_df, bank_config_data, filepath_config="2022/python/configurations/test_filepaths.yaml",
	...
	def q615_1(self):
		"""
		Set total loan costs to 500 and origination charges to 1000.
		"""
	...
	def q650_1(self):
		...
		"""
		name = self.name_prefix + "q650_1.txt"
		path = self.quality_path
		ts = self.ts_df.copy()
		lar = self.lar_df.copy()
	...
	def q655(self):
		"""
		Set Total Units to 5 and Multifamily Affordable Units to NA.
		...
		lar = self.lar_df.copy()
		lar.total_units = "5"
		lar.affordable_units = "NA"
		print("writing {name}".format(name=name))
		utils.write_file(name=name, path=path, ts_input=ts, lar_input=lar)
        
	def q656(self):
		"""
		Set Total Points and Fees to 1111.
